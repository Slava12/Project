...
public class GameTime : MonoBehaviour
{
	...
	/// </summary>
	//private float dayCycleInMinutes = 1450;
	...
	private void Update()
	{
		...
		_timeInSeconds += Time.deltaTime * scale;
		// Update time
		...
		////////////////////////////////////////////////////////
		if (timeInHours >= 0 && timeInHours < 1)
		{
			minutes = (int) (timeInHours*60);
			//lalkalalka = (int)(timeInHours * 3600) - lalka*60;
			
		}
		else
		{
			minutes = (int) (timeInHours%(int) timeInHours*60);
			//lalkalalka = (int)(timeInHours % (int)timeInHours * 3600) - lalka * 60;
			
		}
		seconds = (int)(_timeInSeconds - 3600*(int) timeInHours - 60*minutes);
	...
	void OnGUI()
	{
		...
		//GUI.Box(new Rect(50, 190, 150, 25), "time in h " + timeInHours);
